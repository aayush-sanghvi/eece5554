...
for i in range(20036):
    if 150<= sec[i]:
        ...
        ox.append(orientation_x)
        oy.append(orientation_y)
        oz.append(orientation_z)
        ow.append(orientation_w)
...
#plt.plot((xe/(10**5))/2,-xn/(10**4), c='crimson')
plt.grid(color='grey', linestyle='--', linewidth=1)
plt.plot(utm_e, utm_n, c ='palevioletred')
